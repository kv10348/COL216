...
void encode(char*input,int*coded,struct data_memory*dm,int num);	 //Function to convert text into opcodes.
void decode(struct inst_mem *im,struct data_memory*dm);	// Decode and perform the instructions.
